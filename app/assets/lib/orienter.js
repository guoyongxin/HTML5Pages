...
(function (factory) {
    ...
    Orienter.prototype = {
        ...
        initialize: function (config) {
            window.originTouchPos = { x: 0, y: 0 };
            window.oldTouchPos = { x: 0, y: 0 };
            window.newTouchPos = { x: 0, y: 0 };
            window.drag = { lon: 0, lat: 0 };
            window.aim = { lat: 0, lon: 0 };
            window.fix = { lon: 0, lat: 0 };
            window.lock = true;
            var _config = config || {};
